...
public class IcosahedronList2 {
 ...
 /**
   ...
   */  
   ...
   /** 
    *@return smallest for the smallest edge 
   **/
   ...
   public Icosahedron findIcosahedronWithShortestEdge() {
      ...
      Icosahedron smallest = iList[0];
      int index = 0;
      while (index < numberOfIcosahedrons) {
         if ((smallest.getEdge() > iList[index].getEdge())) {
            smallest = iList[index];
         }
         index++;  
      }   
   ...
   /** 
    *@return largest to get The largest edge 
   **/
   ...
   public Icosahedron findIcosahedronWithLongestEdge() {
      ...
      Icosahedron largest = iList[0];
      int index = 0;
      while (index < numberOfIcosahedrons) {
         if (largest.getEdge() < iList[index].getEdge()) {
            largest = iList[index];
         }
         index++;  
      }   
   ...
   /** 
    *@return smallest to get the smallest volume 
   **/
   ...
   public Icosahedron findIcosahedronWithSmallestVolume() {
      ...
      int index = 0;
      while (index < numberOfIcosahedrons) {
         if ((smallest.volume() > iList[index].volume())) {
            smallest = iList[index];
         }
         index++;  
      }   
   ...
   /** 
    *@return largest to get the largest volume
   **/
   ...
   public Icosahedron findIcosahedronWithLargestVolume() {
      ...
      int index = 0;
      while (index < numberOfIcosahedrons) {
         if (largest.volume() < iList[index].volume()) {
            largest = iList[index];
         }
         index++;   
      }  
